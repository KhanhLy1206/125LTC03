...
namespace BaiTap_MVC.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HoTen,Tuoi")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HoTen,Tuoi")] SinhVien sinhVien)
        {
            if (id != sinhVien.Id)
            {
                return NotFound();
