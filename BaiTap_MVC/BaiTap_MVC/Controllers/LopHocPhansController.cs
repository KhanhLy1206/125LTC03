...
namespace BaiTap_MVC.Controllers
{
    public class LopHocPhansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenLopHocPhan,KhoaHocId,GiaoVienId")] LopHocPhan lopHocPhan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenLopHocPhan,KhoaHocId,GiaoVienId")] LopHocPhan lopHocPhan)
        {
            if (id != lopHocPhan.Id)
            {
                return NotFound();
